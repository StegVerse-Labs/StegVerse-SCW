manifest = {
    "version": 1,
    "description": "StegVerse AutoPatch manifest – central rules for keeping StegTVC config files in sync.",
    ...
    "rules": [
        {
            ...
            "actions": [
                ...
                },
                {
                    ...
                    "pr_labels": ["autopatch", "config-sync"],
                },
            ],

            "conditions": {
                "apply_on": ["manual", "scheduled"],
            ...
            "metadata": {
                ...
                "notes": [
                    "TVC is the canonical source for StegVerse model routing and TV config.",
                    "Other repos mirror tvc_config files into TVC/data for local workflows."
                ],
            }
        }
    ]
